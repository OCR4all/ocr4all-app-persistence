...
/**
 * Defines read/write/special securities with grants.
 *
 * @author <a href="mailto:herbert.baier@uni-wuerzburg.de">Herbert Baier</a>
 * @version 1.0
 * @since 17
 */
public class SecurityGrantRWS extends SecurityGrantCore<SecurityGrantRWS.Right> {
	/**
	...
	/**
	 * Default constructor for read/write/special securities with grants.
	 *
	 * @since 1.8
	 */
	public SecurityGrantRWS() {
		super();
	}

	/**
	 * Creates read/write/special securities with grants.
	 *
	 * @param right The right.
	 * @param user  The user.
	 * @since 1.8
	 */
	public SecurityGrantRWS(Right right, String user) {
		super(right, user);
	}
	 ...
	 * @since 17
	 */
	public SecurityGrantRWS(Set<Grant<Right>> users, Set<Grant<Right>> groups, Right other) {
